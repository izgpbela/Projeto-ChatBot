...
<p>A ideia é criar uma página de login para os dados do pacientes ficar armazenados átraves do chat bot de whatssAp, pode marcação de consultas, onde localizamos qual é o paciente, em qual clínica vamos marcar,  e após marcar aparecer o dia e a hora que o paciente está marcado.
